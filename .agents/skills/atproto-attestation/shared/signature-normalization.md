...
See `spec.md` §curve-support for the reference implementation's per-curve coverage.
...
- Reference crate `atproto-attestation` (`normalize_signature`) — author the low-S behavior; Wolfram ships no ECDSA/attestation helpers.
