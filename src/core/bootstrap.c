...
static const char *const atp_env_template =
    ...
    "\n"
    "# Account credentials for authenticated timeline sync.\n"
    "ATPERSON_IDENTIFIER=\n"
    "ATPERSON_APP_PASSWORD=\n"
    "# Master permission for network writes. Keep false/unset until the\n"
    "# initial neural training run has completed and you explicitly opt in.\n"
    "ATPERSON_ALLOW_EXTERNAL_PUBLISHING=false\n"
    "# Non-secret entity DID. Required for unauthenticated Jetstream learning\n"
    "# so self-authored public records can be excluded by policy.\n"
    "ATPERSON_SELF_DID=\n"
    "\n"
    ...
    "ATPERSON_JETSTREAM_STATE=\n"
    "ATPERSON_CONTROL_STATE=\n"
    "ATPERSON_OUTBOUND_POLICY=\n"
    "ATPERSON_OUTBOUND_BUDGET=\n"
    "ATPERSON_OUTBOUND_AUDIT=\n"
    "ATPERSON_ACTION_JOURNAL=\n"
    "\n"
    ...
    "# First-creation neural topology overrides. Existing persisted models keep\n"
    "# their active topology; class and explicit shape forms are exclusive.\n"
    "ATPERSON_NEURAL_CAPACITY=\n"
    "ATPERSON_NEURAL_EMBEDDING_DIM=\n"
    "ATPERSON_NEURAL_HIDDEN_LAYERS=\n"
