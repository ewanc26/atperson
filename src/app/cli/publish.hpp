...
// document carries it.
//
// Every attempt is appended to the credential-free outbound audit log. Refusals
// and dry runs are reported, not errors; a confirmed write returns 0, an
// execution failure returns 1.
//
