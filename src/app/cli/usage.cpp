...
void print_usage(std::ostream &out) {
    out << "usage:\n"
        ...
        << "  atperson reflect\n"
        << "  atperson metrics [limit] [--since <iso>]\n"
        << "  atperson selfeval\n\n"
        ...
        << "  ATPERSON_OPERATOR_DID     remote control authority; must differ from this "
           "entity's own account DID, and equal is refused. Unset disables the channel "
           "(#143)\n"
...
<< "  ATPERSON_TYPESAFE_API_KEY   opt-in key for the advisory `audit` command\n"
         ...
         << "  ATPERSON_INTENTS             pending social intents on/off (default off)\n"
         << "  ATPERSON_INTENT_MAX_ACTIVE         max concurrent open intents (default 3)\n"
         << "  ATPERSON_INTENT_MAX_CONTINUATIONS  max replies per conversation (default 3)\n"
         << "  ATPERSON_INTENT_WINDOW_DAYS        reply window per intent in days (default 2)\n"
         << "  ATPERSON_REFLECTION                deterministic reflection pass on/off "
            "(daemon hook)\n"
         << "  ATPERSON_REFLECTION_CADENCE_SECONDS     min gap between consolidations (default 86400)\n"
         << "  ATPERSON_REFLECTION_MAX_THOUGHTS        max thoughts one pass writes (default 8, max 64)\n"
         << "  ATPERSON_REFLECTION_WINDOW_SECONDS      trailing analysis window (default 604800)\n"
         << "  ATPERSON_REFLECTION_VALENCE_DELTA_MIN   |valence sum| floor for a trigger (default 0.25)\n"
         << "  ATPERSON_REFLECTION_UNFAMILIAR_MIN      distinct unfamiliar-author floor (default 2)\n"
         << "  ATPERSON_REFLECTION_REPLY_SHIFT_MIN     |reply-ratio shift| floor (default 0.25)\n"
         << "  ATPERSON_SELFEVAL                     longitudinal metrics pass on/off (daemon hook)\n"
         << "  ATPERSON_SELFEVAL_CADENCE_SECONDS     min gap between metric snapshots (default 604800)\n"
         << "  ATPERSON_SELFEVAL_MAX_TRACE           bounded new-author names per window trace (default 8)\n"
         << "  ATPERSON_SELFEVAL_MAX_TRACE_GROUPS    bounded top-valence groups per window trace (default 8)\n\n"
